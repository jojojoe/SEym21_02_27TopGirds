...
enum AdjustKey: String {
    case AdjustKeyAppToken = "8zq7iipsfoxs"
    case AdjustKeyAppLaunch = "uzw6v3"
    case AdjustKeyAppCoinsBuy = "2hsjc8"
...
enum MCorArsConfig: String {
    ...
    case HilighCore_BundlId = "com.TopLikes.IGrids"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var mainVC: TGymeMainVC = TGymeMainVC()
