...
class LMymBCartCoinManager: NSObject {
    ...
    func loadDefaultData() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.TopLikes.IGrids.listone", coin: 100, price: "$1.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.TopLikes.IGrids.listtwo", coin: 300, price: "$2.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.TopLikes.IGrids.listthree", coin: 500, price: "$3.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.TopLikes.IGrids.listfour", coin: 1000, price: "$5.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.TopLikes.IGrids.listfive", coin: 2500, price: "$9.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.TopLikes.IGrids.listsix", coin: 4000, price: "$11.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.TopLikes.IGrids.listseven", coin: 6000, price: "$13.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.TopLikes.IGrids.listeight", coin: 8000, price: "$15.99", color: "#C9FFEE")
